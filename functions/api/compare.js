...
- shop_on_ebay: Set to true if this item is a physical product, game, toy, book, or anything people commonly buy on eBay. Set to false for software, SaaS, online services, streaming platforms, concepts, people, animals/pets, or anything that isn't a purchasable physical item. Examples: Chess sets = true, Rubik's Cube = true, mattresses = true, headphones = true, NordVPN = false, Netflix = false, "The Beatles" = false, "Roth IRA" = false, Cat = false, Dog = false, Goldfish = false. Set to false for car TYPES or categories (sedan, SUV, hybrid, 4WD), drivetrain concepts, or abstract decisions like "buying vs leasing." Only set to true for specific car PARTS or ACCESSORIES people buy on eBay.
